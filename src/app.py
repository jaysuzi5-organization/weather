...
from api import health, info, weather
...
app = FastAPI(
    title="Weather API",
    version="1.0.0",
    openapi_url="/api/v1/weather/openapi.json",
    docs_url="/api/v1/weather/docs",
    lifespan=lifespan
)
...
app.mount("/weather/test", StaticFiles(directory="static", html=True), name="test")
